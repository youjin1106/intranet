...
const Navbar = () => {
	...
	const isNotice = location.pathname === "/notice" ? "text-primary" : "text-gray01";
	...
	return (
		<div className="flex flex-col justify-between w-[200px] p-[20px] bg-bg01">
			<div>
				<p
					onClick={() => {
						navigate("/");
				...
				<ul>
					...
					<li>
						<Link className={`${isNotice} text-lg flex gap-2 py-2`} to="/notice">
							<NotificationsActiveOutlinedIcon className={`${isNotice} text-gray01`} />
							공지사항
						</Link>
					</li>
				</ul>
